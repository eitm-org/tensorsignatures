...
def collapse_data(snv):
    ...
    Returns:
        snv (array, shape :math:`(3, 3, (t_1+1), \dots, (t_l), p, n)`):
            Collapsed SNV array.
    """
    i0, i1, i2, i3, i4, i5, i6, i7 = [slice(None)] * (snv.ndim - 3) + [0] + [slice(None)] * 2
    col1 = snv[i0, i1, i2, i3, i4, i5, i6, i7]
    col2 = []
    dims = [
        (1, 1), (1, 0), (1, 2),
        (0, 1), (0, 0), (0, 2),
    ...
    for i, j in dims:
        ...
        col2.append(snv[i0, i1, i2, i3, i4, i5, i6, i7])
...
def prepare_data(path, output):
    ...
    with h5.File(path, 'r') as fh:
        # load extracted snvs
        snv = fh["SNV"][()].T.reshape(3, 3, 16, 4, 2, 2, 96, -1)
